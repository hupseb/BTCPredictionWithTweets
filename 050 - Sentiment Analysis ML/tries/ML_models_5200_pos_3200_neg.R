...
table(as.numeric(as.factor(tweet_all[7701:8300,2])),results[,"SVM_LABEL"])
recall_accuracy(as.numeric(as.factor(tweet_all[7701:8300,2])),results[,"SVM_LABEL"])
confusionMatrix(as.numeric(as.factor(tweet_all[7701:8300,2])),results[,"SVM_LABEL"])
