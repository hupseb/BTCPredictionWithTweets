...
devtools::install_github("timjurka/RTextTools/RTextTools", force = TRUE)
...
newmat <- create_matrix(nd, originalMatrix = mat)
...
res = data.frame(nd, svmpred, attr(svmpred, "decision.values"), attr(svmpred, "probabilities"))
colnames(res) <- c("word", "svm_sentiment", "decisionValue", "pos_prob", "neg_prob")
View(res)
