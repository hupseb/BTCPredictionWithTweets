...
write.csv(profit_res, file = "0_1_0_OOS_rolling_without_xreg_diff_5d_window.csv",row.names=FALSE)
...
lmProfit = lm(anovaData$profit ~
              ...
              #interactions
              anovaData$twitter_sent_regs:anovaData$arima_size +
              anovaData$twitter_sent_regs:anovaData$window_week_start_day +
              anovaData$arima_size:anovaData$window_week_start_day +
              anovaData$twitter_sent_regs:anovaData$btc_tec_regs
              )
